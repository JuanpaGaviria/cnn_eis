...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_folder", type=str, help='training dataset')
    ...
    image_folders_path = args.data_folder
    print(image_folders_path)
    ...
    train_ds = tf.keras.utils.image_dataset_from_directory(args.data_folder,
